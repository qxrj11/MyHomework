...
<body>
		...
		<form action="AddCartServlet" method="post">
			<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${box.pimage}">
					</div>

					<div class="col-md-6">
						<div><strong>${box.pname }</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>编号：${box.pid }</div>
							<input type="hidden" name="pid" value="${box.pid }">
						</div>

						<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${box.shop_price }元/份</strong> 参 考 价： <del>￥${box.market_price }元/份</del>
						</div>
