	...
	<form action="${pageContext.request.contextPath}/SubmitOrderServlet" method="post">
		<div class="container">
				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${box.getCartItems() }" var="i">
								<tr class="active">
								...
								<td width="10%">
									<input type="text" name="quantity" value="${i.count}" maxlength="4" size="10" readonly>
								</td>
								<td width="15%">
									<span class="subtotal">￥${i.subtotal}</span>
								</td>
								<td>
									<a href="RemoveCartServlet?pid=${i.product.pid }" class="delete">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">${box.total }</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${box.total }元</strong>
				</div>
